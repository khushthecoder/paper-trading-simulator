...
const { buyStock, sellStock, getPortfolio, getTransactions, searchSymbol, getPrice, getCandles, getIndices, getCompanyProfile, getFinancials, getNews, getMarketNews, getRecommendations } = require('../controllers/tradeController');
